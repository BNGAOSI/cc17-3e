...
import com.ambiongltb.fulldashboardededdneddy.databinding.ActivityOtherDocsFormBinding;
...
public class otherDocsForm extends BaseActivity {
    ...
    private void showConfirmationDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(otherDocsForm.this);
