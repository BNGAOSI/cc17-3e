...
import com.example.fulldashboardededdneddy.model.FinishedStatusDocuments

class FinishedStatusAdapter : RecyclerView.Adapter<FinishedStatusAdapter.MyViewHolder>(){
    private val documentList = ArrayList<FinishedStatusDocuments>()
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(
            R.layout.finished_status_item, parent, false
        )
    ...
    fun updateDocumentList(documentList: List<FinishedStatusDocuments>) {
